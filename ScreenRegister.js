...
import IconUnion from 'react-native-vector-icons/Ionicons'
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.groupRegister}>
                ...
                <View  style={styles.textInputTK}>
                <MaterialCommunityIcons name='email-outline' size={24} color={'gray'}/>
                <TextInput style={{ marginLeft : 5}} placeholder='Email' onChangeText={(Text) => setEmail(Text)} />

                </View>
                <View style={styles.textInputMK}>
                <MaterialCommunityIcons name='form-textbox-password' size={24} color={'gray'}/>
                <TextInput  style={{ marginLeft : 5}} placeholder='Mật khẩu' onChangeText={(Text) => setPassword(Text)}/>
                </View>
                <View style={styles.textInputMK}>
                <IconUnion name='person-add-outline' size={24} color={'gray'}/>
                <TextInput style={{ marginLeft : 5}} placeholder='Họ và Tên' onChangeText={(Text) => setName(Text)}/>
                </View>
                <View style={styles.textInputMK}>
                <AntDesign name='phone' size={24}  color={'gray'}/>
                <TextInput style={{ marginLeft : 5}}  placeholder='Số điện thoại' onChangeText={(Text) => setNumberphone(Text)}/>

                </View>
                <View style={styles.textInputMK} >
                <IconUnion name='location-outline' size={24} color={'gray'}/>
                <TextInput placeholder='Địa chỉ' onChangeText={(Text) => setAddress(Text)}/>
