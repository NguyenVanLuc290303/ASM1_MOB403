...
export default function ScreenPageUser({ navigation}) {
    const { userData } = User();
                    ...
                    <View style={styles.cardPost }>
                            ...
                            <View style={styles.itemUser}>
                                ...
                                <View style={{flex : 1.5, flexDirection : 'row' , paddingRight : 10 , justifyContent : 'space-between'}}>
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('ScreenUpdatePost' , item ={
                                                                            id : item.id,
                                                                            idUser : item.idUserPost,
                                                                            content : item.contentPost,
                                                                            image : item.imagePost,
                                                                            nameUser : item.nameUserPost,
                                                                            imageUser : item.imageUserPost,
                                                                            time : item.timePost
                                                                        })}>
                                        <FontAwesomeIcon icon={faEllipsis} size={25} color='black' />
                                    </TouchableOpacity>
