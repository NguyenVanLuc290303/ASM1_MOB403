...
//   firebase.initializeApp(ConnectFirebase);
// }
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.textLogin}>Login</Text>
            ...
            <TextInput style={{ marginLeft : 5}} defaultValue={email}  placeholder='Email' onChangeText={(Text) => setEmail(Text)}/>
            </View>
            <View style={styles.textInputMK} >
            <MaterialCommunityIcons name='form-textbox-password' size={24} color={'gray'}/>
            <TextInput style={{ marginLeft : 5}} defaultValue={password} secureTextEntry={true} placeholder='Password' onChangeText={(Text) => setPassword(Text)}/>
            </View>
